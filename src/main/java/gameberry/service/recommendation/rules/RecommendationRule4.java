...
public class RecommendationRule4 extends RecommendationBaseRule {

    public RecommendationRule4(RecommendationBaseRule nextRule, ProcessedInput input, ProcessedOutput output){
