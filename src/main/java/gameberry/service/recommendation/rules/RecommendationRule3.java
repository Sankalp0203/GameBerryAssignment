...
public class RecommendationRule3 extends RecommendationBaseRule {

    public RecommendationRule3(RecommendationBaseRule nextRule, ProcessedInput input, ProcessedOutput output){
    ...
    private Set<String> setBaseCriteriaAndFilter(Map<AttributeEnum, Map<String, Set<String>>> classifiedRestraunts, Set<Restaurant> restrauntSet){
        ...
        baseCriteriaInput = new RatingCriteria(baseCriteriaInput, 4.5F, List.of(ComparisonEnum.GREATER_THAN, ComparisonEnum.EQUAL_TO));
