...
public class RecommendationRule6 extends RecommendationBaseRule {

    public RecommendationRule6(RecommendationBaseRule nextRule, ProcessedInput input, ProcessedOutput output){
    ...
    private Set<String> setBaseCriteriaAndFilter(Map<AttributeEnum, Map<String, Set<String>>> classifiedRestraunts, Set<Restaurant> restrauntSet){
        ...
        baseCriteriaInput = new RatingCriteria(baseCriteriaInput, 4F, List.of(ComparisonEnum.LESS_THAN));
